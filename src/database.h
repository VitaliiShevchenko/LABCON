...
LabconRegisterFunction labconRegistersDatabase[] = {
  ...
  {"SetTestTime",          0x2002, "Setting the nominal testing time, s",                              900},
  {"SetMaxTorque",         0x2003, "Setting the maximum torque for the device, Nm ",                    40},
  {"SetMaxCurrent",        0x2004, "Setting the maximum current for the device, A val*1000",         18000},
  {"SetMaxVoltage",        0x2005, "Setting the maximum voltage for the device, V",                    253},
  {"SetMaxPower",          0x2006, "Setting the maximum power for the device, W, val*10",            39600},
  ...
  {"Voltage",              0x4005, "Store measured voltage,V",                                           0},
